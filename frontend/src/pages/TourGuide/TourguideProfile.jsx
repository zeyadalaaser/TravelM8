...
const TourGuideProfilePage = () => {
  ...
  const [countryCode, setCountryCode] = useState(
    profile && profile.mobileNumber ? profile.mobileNumber.slice(0, 2) : "+1"
  ); // Default to '+1'
  const [mobileNumber, setMobileNumber] = useState(
    profile && profile.mobileNumber ? profile.mobileNumber.slice(2) : ""
  ); // Default to empty
                  ...
                  <div className="flex items-center space-x-2">
                    <Select
                      onValueChange={(value) => {
                        ...
                        handleInputChange({
                          target: { name: "mobileNumber", value: mobileNumber },
                        }); // Keep mobile number intact
                      }}
                    >
      ...
      <footer className="bg-gray-800 text-white py-8">
        <div className="container mx-auto px-4">
          ...
          <div className="mt-8 border-t border-gray-700 pt-8 flex justify-between items-center">
            <p className="text-sm">
              &copy; 2023 Expedia, Inc. All rights reserved.
            </p>
